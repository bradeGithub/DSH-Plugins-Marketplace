...
import { isSensitiveEnvKey, isBootstrapOnlyEnvKey, isValidEnvKey, isTrustedHost, hasPatchEntry, hasDshPluginDeclaration, isBundlePackage, compareVersions, comparePre, shouldUpdate, isPnpmLocalDependency, isCliInstallTarget, safeAssign } from "./domain/validation.js";
...
const registryCache = createRegistryCacheAdapter({
  ...
  paths: {
    ...
    bundledFile: (kind) => join(MODULE_DIR, "..", kind === "skills" ? "skills.json" : "registry.json"),
  },
  normalizeRepo,
