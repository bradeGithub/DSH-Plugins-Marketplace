        ...
        try {
          ...
          if (cliInstall) {
            ...
            try {
              ...
              await saveInstalled(repo, { type: "cli", name: cliInstall.target, names: null, location: null, version: null, installedAt: Date.now() });
