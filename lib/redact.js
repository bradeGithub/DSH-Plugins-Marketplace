...
const KNOWN_KEY_RULES = [
  ...
  { re: /\bnpm_[A-Za-z0-9]{20,64}\b/g, name: "npm" },
  { re: /\bhf_[A-Za-z0-9]{34,40}\b/g, name: "huggingface" },
  ...
  // LLM 聚合/推理商（Groq/xAI/Perplexity/Fireworks/Cerebras/Cohere）
  { re: /\bgsk_[A-Za-z0-9]{20,}\b/g, name: "groq" },
  { re: /\bxai-[A-Za-z0-9]{20,}\b/g, name: "xai" },
  { re: /\bpplx-[A-Za-z0-9]{20,}\b/g, name: "perplexity" },
  { re: /\bfw_[A-Za-z0-9]{20,}\b/g, name: "fireworks" },
  { re: /\bcsk-[A-Za-z0-9]{20,}\b/g, name: "cerebras" },
  // 支付/通信/开发服务
  { re: /\b[srk]k_(?:live|test)_[A-Za-z0-9]{16,}\b/g, name: "stripe" },
  ...
  { re: /\bnfp_[A-Za-z0-9]{20,}\b/g, name: "netlify" },
  ...
  // Telegram bot token（数字 ID : AA 固定头 + 34 位 base64 形态）
  { re: /\b\d{5,16}:AA[A-Za-z0-9_-]{34}\b/g, name: "telegram" },
  // Twilio API Key（SK + 32 hex）；Airtable personal token（pat + . + 64 hex）
  ...
  { re: /\bbce-[A-Za-z0-9]{20,}\b/g, name: "baidu" },
...
const PATH_RULES = [
  ...
  { re: /\$HOME\/[^\s"]+|\/home\/[^/\s"$]+((?:\/[^\s"/:$();|,]+)*)/g, to: (_m, rest) => `~/<user>${rest}` },
];
