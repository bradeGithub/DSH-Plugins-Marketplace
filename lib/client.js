  ...
  factory: (require) => {
    ...
    function injectStyles() {
      ...
      el.textContent = [
        ...
        "body[data-dsh-qq98]:not([data-ds-dark-theme]) .dshm-dim,body[data-dsh-trading]:not([data-ds-dark-theme]) .dshm-dim,body[data-dsh-xp]:not([data-ds-dark-theme]) .dshm-dim,body[data-dsh-miku]:not([data-ds-dark-theme]) .dshm-dim{color:var(--dsw-alias-label-secondary)!important}",
        ...
        "body[data-dsh-qq98]:not([data-ds-dark-theme]),body[data-dsh-trading]:not([data-ds-dark-theme]),body[data-dsh-xp]:not([data-ds-dark-theme]),body[data-dsh-miku]:not([data-ds-dark-theme]){--dsw-alias-label-primary-foreground:var(--dsw-alias-label-primary)}"
      ].join("\n");
